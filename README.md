...
- Network protocols (HTTP, MQTT, DNS basics, ICMP)
- Automation scripts (Linux/bash + Python)
...
### 🔹 **Backend & Automation**
- Python modular architectures  
- API design (FastAPI)  
- Async workers  
- Task schedulers / cron jobs  
- CLI tools (argparse + custom modules)
...
<div align="center">
  <img src="https://github.com/kerem-apaydin/kerem-apaydin/blob/main/github-metrics.svg" alt="Metrics" width="50%">
</div>
